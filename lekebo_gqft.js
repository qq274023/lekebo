 ...
 * 项目类型：APP
 * 项目名称：广汽丰田
 * 项目抓包：抓gw.nevapp.gtmc.com.cn下的Authorization & deviceId填入变量
 * 项目变量：lekebo_gqft_Cookie
 * 项目定时：每40分钟运行一次
 * cron: 10 12 * * *
...
let envSplitor = ["@", "\n"]; //多账号分隔符
let msg = '';
let userCookie = ($.isNode() ? process.env.lekebo_gqft_Cookie : $.getdata('lekebo_gqft_Cookie')) || '';
let userList = [];
let userIdx = 0;
let userCount = 0;
//---------------------- 自定义变量区域 -----------------------------------
